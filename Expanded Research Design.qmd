...
#3b. Descriptive Statistics and Graphical Representations
...
Final regression will be lm(Corruption \~ Aid + Sector + Aid*Sector+ country.fixed.effects + year.fixed.effects + individual.controls). lm(index \~ log_aid*sector + countryname + year + controls). Fixed effects should control for potential confounders.

#4b. Empirical Extension
